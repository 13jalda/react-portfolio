...
export default class PortfolioForm extends Component {
    ...
    constructor (props){
        ...
        this.state = {
            ...
            editMode: false,
            apiUrl: "https://jonalda.devcamp.space/portfolio/portfolio_items",
            apiAction: "post"
        };
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                editMode: true,
                apiUrl: `https://jonalda.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch",
    ...
    handleSubmit(event) {
        //https://jonalda.devcamp.space/portfolio/portfolio_items
